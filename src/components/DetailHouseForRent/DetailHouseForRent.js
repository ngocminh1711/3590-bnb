                    ...
                    <div className="grid grid-rows-4 gap-4">
                        ...
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}
                                 stroke="currentColor" className="w-6 h-6 float-left">
                                <path strokeLinecap="round" strokeLinejoin="round"
                                      d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.4 2.245 4.5 4.5 0 008.4-2.245c0-.399-.078-.78-.22-1.128zm0 0a15.998 15.998 0 003.388-1.62m-5.043-.025a15.994 15.994 0 011.622-3.395m3.42 3.42a15.995 15.995 0 004.764-4.648l3.876-5.814a1.151 1.151 0 00-1.597-1.597L14.146 6.32a15.996 15.996 0 00-4.649 4.763m3.42 3.42a6.776 6.776 0 00-3.42-3.42"/>
                            </svg>
                            <div className="grid grid-rows-2">
                                <h1 className="text-black-300 text-1.5xl title-font font-medium mb-1 float-left pl-2">Designed
                                    by</h1>
                        ...
                        <div>
                            ...
                            <div>
                                <h1 className="text-black-300 text-1.5xl title-font font-medium mb-1 float-left pl-2">Free
                                    cancellation for 48 hours.</h1>
                            </div>
                        </div>
                    </div>
                    <div>
                                ...
                                <div className="flex bg-100 h-auto">
                                    <div className="m-auto">
                                        <div className="mt-5 rounded-lg shadow">
                                            ...
                                            <div className="px-5 pt-0">
                                                <h1 className="text-gray-900 text-1.75xl title-font font-medium mb-1 px-7 py-5 pb-5 inline">Total
                                                    before taxes </h1>
                                                <h1 className="text-gray-900 text-1.75xl title-font font-medium mb-1 px-7 py-5 pb-5 inline">$ </h1>
                                            </div>
