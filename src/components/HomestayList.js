...
function HomestayList() {
  ...
  console.log(houseForRents)

  return (
    <div>
      <div className="bg-white">
        <div className="mx-auto max-w-2xl  py-16 px-4 sm:py-10 sm:px-6 lg:max-w-7xl lg:px-8">
          <h2 className="text-2xl pt-0 font-bold tracking-tight text-gray-900">
            House For Rent
          </h2>
          <div className="mt-3 grid grid-cols-1 gap-y-103 gap-x-4 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8 z-20">
            {houseForRents &&
