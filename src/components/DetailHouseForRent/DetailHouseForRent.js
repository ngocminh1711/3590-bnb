            ...
            {houseForRent && houseForRent && host ? (
                <>
                    ...
                    <div className="mx-auto max-w-10xl py-2  sm:py-2 sm:px-6 lg:max-w-7xl lg:px-8">
                                    ...
                                    <div
                                        ...
                                        <div className="relative w-auto my-6 mx-auto max-w-3xl">
                                            ...
                                            <div
                                                ...
                                                {/*header*/}
                                                <div
                                                    className="flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t"></div>
                                                {/*body*/}
                                                <div
                        ...
                        <div className="grid grid-cols-2 gap-4 px-24 pb-0">
                    ...
                    <span className="relative inline-block px-3 py-1 font-semibold text-green-900 leading-tight">
                      <span
                          aria-hidden
                          className="absolute w-1.5/6 h-2/5 inset-0 bg-green-200 opacity-50 rounded-full"
                      />
                      <span className="relative text-xs text-center">
                        {houseForRent.status}
                                    ...
                                    <>
                                        {houseForRent.status === "Occupied" ? (
                                            <>
                        <span className="relative inline-block px-5 py-1 font-semibold text-black leading-tight">
                          <span
                              aria-hidden
                              className="absolute w-1.5/6 h-2/5 inset-0 bg-red-600 opacity-50 rounded-full"
                          />
                          <span className="relative text-xs text-center">
                            {houseForRent.status}
                          </span>
                        ...
                        <span className="relative inline-block px-5 py-1 font-semibold text-black leading-tight">
                          <span
                              aria-hidden
                              className="absolute w-1.5/6 h-2/5 inset-0 bg-yellow-400 opacity-50 rounded-full"
                          />
                          <span className="relative text-xs text-center">
                            {houseForRent.status}
                          </span>
