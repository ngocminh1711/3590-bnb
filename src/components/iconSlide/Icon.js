import {
  ...
  export const locationsTab = [
    ...
    { id: 5, label: 'Double bed', icon: <GiKidSlide size={24} /> },
    { id: 6, label: 'Single bathroom', icon: <AiOutlineCoffee size={24} /> },
    { id: 7, label: 'Multiple bathroom ', icon: <GiSpaceNeedle size={24} /> },
    { id: 8, label: 'Address', icon: <FaCampground size={24} /> },
