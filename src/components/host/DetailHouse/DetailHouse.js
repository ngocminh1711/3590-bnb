...
function DetailHouse() {
    ...
    const data = useSelector((state) => state.getHouse.house)
    ...
    const getHouse = async () => {
        return await axios.get(`http://localhost:8000/api/products/get-house-for-rent-by-id/${idProduct}`)
    }

    useEffect(() => {
        getHouse().then(res =>
            dispatch(getDetailHouse(res.data.data))
        )
                ...
                <div className="mx-auto max-w-10xl py-14 sm:py-14 sm:px-6 lg:max-w-7xl lg:px-8">
                   <div className="grid grid-cols-2">
                            ...
                            <div className="py-12 grid grid-cols-1 ">
                                <div>
                                    ...
                                    <div className="py-4">
                                        ...
                                        >{data.image_view && data.image_view.map((item,index) => (
                                            <div
                                                key={index}
                       ...
                       <div className="py-4">
                           ...
                           <p className="text-slate-400">{data.typeRoom.name}</p>
                           <p className="text-slate-400">Bedroom: {data.numberOfBedrooms}</p>
                           <p className="text-slate-400">Bathroom: {data.numberOfBathrooms}</p>
