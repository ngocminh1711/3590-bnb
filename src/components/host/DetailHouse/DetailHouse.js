            ...
            <div>
                {house && house.name ?
                    <div className="bg-white">
                        <div className="mx-auto mt-20 max-w-10xl py-14 sm:py-14 sm:px-6 lg:max-w-7xl lg:px-8">
                                        ...
                                        <ul className="flex flex-col py-4">
                                            ...
                                            <li>
                                                ...
                                                <span
                                                    ...
                                                    <span
                                                        className="text-gray-900 text-sm-2xl title-font">Shopping</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#"
                                            ...
                                            <li>
                                                ...
                                                <span
                                                    ...
                                                    <span
                                                        className="text-gray-900 text-sm-1xl title-font">Profile</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                      ...
                      ×
                                                                                ...
                                                                                <div className="px-5 pb-5">
                                                                                    ...
                                                                                    <div className="flex">
                                                                                        <div
                                                                                            ...
                                                                                            <select
                                                                                                defaultValue={house.typeRoom?._id}
                                                                                                name="typeRoom"
                                                                                                onChange={(e) => {
                                                                                                    setFormEdit({
                                                                                                        ...formEdit,
                                                                                    ...
                                                                                    <div
                                                                                        className="flex-grow w-full pr-2">
                                                                                        <select
                                                                                            defaultValue={house.status._id}
                                                                                            name="status"
                                                                                            onChange={(e) => {
                                                                                                setFormEdit({
                                                                                                    ...formEdit,
                                                                                    ...
                                                                                    <div className="flex">
                                                                                        <div
                                                                                            className="flex-grow w-1/4 pr-2">
                                                                                            <select
                                                                                                defaultValue={house.numberOfBedrooms}
                                                                                        ...
                                                                                        <div
                                                                                            className="flex-grow w-1/4 pr-2">
                                                                                            <select
                                                                                                defaultValue={house.numberOfBathrooms}
                        ...
                        />
                                    ...
                                    <div className="pt-4 mt-10">
                                        ...
                                        <div className="py-4">
                                            <h2 className="text-gray-900 text-1xl title-font font-medium">Listing
                                                title</h2>
