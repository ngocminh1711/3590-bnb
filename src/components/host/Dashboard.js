...
function ListHost() {
  ...
  const getApi = async () => {
    return await axios.get(`http://localhost:8000/api/products/${userLogin}`);
  };
  const handleClick = (e) => {
    let id = e;
        ...
        <>
          <div className="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 pr-10 lg:px-8 mb-64  ">
            ...
            <div className=" ml-32 mr-32">
              <div className="w-full text-center align-middle inline-block min-w-800 shadow overflow-hidden bg-white shadow-dashboard px-8 pt-3 rounded-bl-lg rounded-br-lg">
